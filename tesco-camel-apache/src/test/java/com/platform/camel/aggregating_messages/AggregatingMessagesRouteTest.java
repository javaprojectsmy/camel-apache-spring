...
public class AggregatingMessagesRouteTest extends CamelTestSupport {

    @Override
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new AggregatingMessagesRoute();
    }
    ...
    public void aggregatesTwoMessagesIntoOne() throws Exception {
        ...
        start.sendBodyAndHeaders(null, toHeaderMap("invoiceId", "invoiceOne", "invoiceItemTotal", BigDecimal.valueOf(2)));
        start.sendBodyAndHeaders(null, toHeaderMap("invoiceId", "invoiceOne", "invoiceItemTotal", BigDecimal.valueOf(3)));
    ...
    public void aggregatesMessagesByCorrelationKey() throws Exception {
        ...
        start.sendBodyAndHeaders(null, toHeaderMap("invoiceId", "invoiceOne", "invoiceItemTotal", BigDecimal.valueOf(2)));
        start.sendBodyAndHeaders(null, toHeaderMap("invoiceId", "invoiceTwo", "invoiceItemTotal", BigDecimal.valueOf(4)));
        start.sendBodyAndHeaders(null, toHeaderMap("invoiceId", "invoiceOne", "invoiceItemTotal", BigDecimal.valueOf(3)));
        assertMockEndpointsSatisfied();
    }

    private Map<String, Object> toHeaderMap(Object... keyValuePairs) {
