...
package com.platform.camel.routing_different_destinations;
...
public class RoutingToDifferentDestinationsRouteSpringTest extends CamelSpringTestSupport {
    ...
    protected AbstractApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext("META-INF/spring/routing-different-destinations-context.xml");
    }
