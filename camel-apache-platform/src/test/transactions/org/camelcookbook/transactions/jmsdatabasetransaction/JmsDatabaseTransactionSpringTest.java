...
package org.camelcookbook.transactions.jmsdatabasetransaction;
...
public class JmsDatabaseTransactionSpringTest extends CamelSpringTestSupport {
    ...
    protected AbstractApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext("META-INF/spring-transactions/jmsDatabaseTransaction-context.xml");
    }
