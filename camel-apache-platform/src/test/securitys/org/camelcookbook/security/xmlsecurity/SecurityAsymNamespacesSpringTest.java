 ...
 */
public class SecurityAsymNamespacesSpringTest extends CamelSpringTestSupport {

    @Override
    protected AbstractApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext("META-INF/spring-secritys/xmlsecurity-asymNamespaces-context.xml");
    }
