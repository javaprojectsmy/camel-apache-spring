...
public class MyProcessorSpringTest extends CamelSpringTestSupport {

    @Override
    protected AbstractApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext("META-INF/spring-extends/processor-context.xml");
    }

    @Test
    public void testMyProcessorSpring() throws Exception {
    ...
    @Test
    public void testMyProcessor2Spring() throws Exception {
