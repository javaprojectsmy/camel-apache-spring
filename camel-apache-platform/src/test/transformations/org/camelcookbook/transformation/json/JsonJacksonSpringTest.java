...
public class JsonJacksonSpringTest extends CamelSpringTestSupport {

    @Override
    protected AbstractApplicationContext createApplicationContext() {
        return new ClassPathXmlApplicationContext("META-INF/spring-transformations/json-jackson-context.xml");
    }

    @Test
    public void testJsonJacksonSpringMarshal() throws Exception {
        View view = new View();
    ...
    @Test
    public void testJsonJacksonSpringUnmarshal() throws Exception {
